...
saveRDS(vang_rets, file ="/Users/mandarphatak/Documents/GitHub/Asset_Pricing/00_Data/vang_rets.rds")
```
...
```{r}
ishares_rets <- ishares_prices |> 
  group_by(symbol) |> 
  tq_transmute(
    select = adjusted,
    mutate_fun = periodReturn,
    col_rename = "ishares_ret"
  ) |> 
  mutate(date=rollback(date,roll_to_first = TRUE))
saveRDS(ishares_rets, file = "/Users/mandarphatak/Documents/Github/Asset_Pricing/00_Data/ishares_rets.rds")
