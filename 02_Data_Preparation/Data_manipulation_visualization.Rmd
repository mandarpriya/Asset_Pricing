...
```{r}
cons_disc_rets <- readRDS("/Users/mandarphatak/Documents/GitHub/Asset_Pricing/00_Data/sp500_sector_rets.rds") |> filter(symbol == "^SP500-25")
...
#     limits = c(-.3,.15),
  ...
  annotate("text",
           ...
           size = 3) +
  labs(
    title = "S&P 500 Consumer Discretionary Monthly Returns",
    subtitle = "Period: 2004-2025",
    caption = "Source:-Yahoo Finance",
    x = "",
    y = ""
...
```{r}
utilities_rets <- readRDS("/Users/mandarphatak/Documents/GitHub/Asset_Pricing/00_Data/sp500_sector_rets.rds") |> filter(symbol == "^SP500-55")
...
#     limits = c(-.3,.15),
  ...
  annotate("text",
           ...
           size = 3) +
  labs(
    title = "S&P 500 Utilities Monthly Returns",
    subtitle = "Period: 2004-2025",
    caption = "Source:-Yahoo Finance",
    x = "",
    y = ""
...
##### End of Stage 1 :- Visualization of the Time Series Plot for Sectoral ETFs and S&P 500 Sectoral indices, and understanding the trends, events.

The next step is the modeling:- We will start with the CAPM model, for this we combine the fama french 3 factors data with the sectoral etfs returns data, and the same with the S&P 500 sectoral indices. We use the rolling window concept to obtain the ßeta
