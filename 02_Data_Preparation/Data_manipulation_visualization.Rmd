...
# Generate the plot
tech_growth_plot <- plot_investment_growth(tech_rets)
print(tech_growth_plot)
```
```{r}
plot_investment_growth <- function(data) {
  growth_data <- data |>
...
```
# this shows that the  investment growth for  IYW is more than compared to S&P 500 technology sector index.
